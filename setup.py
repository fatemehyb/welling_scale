...
setup(name = "call_all_function_2" ,options={'build_exe': {"includes": ["numpy.core._methods","scipy.ndimage._ni_support","scipy","cytoolz","skimage","mayavi","mayavi.mlab","seaborn","itk","SimpleITK","itkLazy","sklearn"
],"include_files":[i for i in result3]
}},
      version = "0.1" ,
      description = "" ,
      executables = [Executable("call_all_function_2.py")])
