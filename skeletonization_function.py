...
def main(dis_volume,inta_volume,digas_volume,Low,High):
    ...
    proportion2=len(intersection_area[rmini:rmaxi,cmini:cmaxi,zmini:zmaxi])/len(expanded_digastrix[rmino:rmaxo,cmino:cmaxo,zmino:zmaxo])
